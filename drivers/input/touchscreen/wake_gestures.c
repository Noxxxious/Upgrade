...
/* Samsung GS8+ */
#define SWEEP_Y_MAX_PLUS             2960
#define SWEEP_X_MAX_PLUS             1440
#define SWEEP_EDGE_PLUS		130
#define SWEEP_Y_LIMIT_PLUS           SWEEP_Y_MAX_PLUS-SWEEP_EDGE_PLUS
#define SWEEP_X_LIMIT_PLUS           SWEEP_X_MAX_PLUS-SWEEP_EDGE_PLUS
#define SWEEP_X_B1_PLUS              480
#define SWEEP_X_B2_PLUS              940
#define SWEEP_X_START_PLUS		720
#define SWEEP_X_FINAL_PLUS           360
#define SWEEP_Y_START_PLUS		1066
#define SWEEP_Y_NEXT_PLUS            300
...
static int __init wake_gestures_init(void)
{
	int rc = 0;
 	...
 	if (variant_plus == IS_PLUS) {
		...
		sweep_x_b2 = SWEEP_X_B2_PLUS;
		sweep_y_start = SWEEP_Y_START_PLUS;
		sweep_x_start = SWEEP_X_START_PLUS;
		sweep_x_final = SWEEP_X_FINAL_PLUS;
